...
import com.xkf.po.Article;
import com.xkf.po.Articles;
import com.xkf.po.Image;
import com.xkf.po.ImageMessage;
import com.xkf.po.News;
import com.xkf.po.NewsMessage;
import com.xkf.po.TemplateMessage;
...
public class MessageUtil {
	...
	public static String textMessageToXML(TextMessage textMessage) {
		...
		//将根替换成“XML”字符，不然就是类名称作为根了。
		xStream.alias("xml", textMessage.getClass());
		String rString=xStream.toXML(textMessage);
		System.out.println("textMessageToXML返回："+rString);
 ...
 */
	public static String initTemplateMessage(String touser,String templateId) {
		...
		jObject.put("url", "baidu.com");
		jObject.put("data", "{\"info\":{\"value\":\"恭喜您申请成功\",\"color\":\"#173177\"}}");		
